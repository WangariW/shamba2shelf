...
import { Bell, Heart, Trash } from "lucide-react";
...
export default function BuyerDashboard() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#1B1B1B] text-gray-800 dark:text-gray-200 py-10 px-6 md:px-16 transition-colors duration-300 relative">
      ...
      {/* Profile Card */}
      <motion.div className="flex items-center bg-gray-50 dark:bg-[#252525] p-6 rounded-xl shadow-lg mb-10">
        <div className="w-20 h-20 bg-gray-300 dark:bg-gray-700 rounded-full overflow-hidden mr-6 flex-shrink-0">
          {profile.avatar ? <img src={profile.avatar} alt="Avatar" className="w-full h-full object-cover"/> : null}
        </div>
        <div>
          <h2 className="text-2xl font-bold text-[#3B1F0E] dark:text-amber-400">{profile.name}</h2>
      ...
      <div className="mb-12">
        ...
        <div className="flex flex-wrap gap-4 mb-4">
          ...
          />
          <select value={filterStatus} onChange={(e) => setFilterStatus(e.target.value)} className="p-2 rounded-lg bg-gray-100 dark:bg-[#333] dark:text-gray-200 outline-none">
            <option>All</option>
      ...
      <div className="mb-12">
        ...
        <div className="flex flex-wrap gap-4 mb-4">
          <input
            ...
            className="p-2 rounded-lg bg-gray-100 dark:bg-[#333] dark:text-gray-200 outline-none flex-grow"
          />
          <select value={filterType} onChange={(e) => setFilterType(e.target.value)} className="p-2 rounded-lg bg-gray-100 dark:bg-[#333] dark:text-gray-200 outline-none">
            <option>All</option>
            <option>Beans</option>
